...
export const inputClasses =
  "h-10 w-full rounded-lg border border-line bg-surface px-3 text-sm placeholder:text-faint/70 focus:border-ink";

export const textareaClasses =
  "w-full rounded-lg border border-line bg-surface px-3 py-2 text-sm placeholder:text-faint/70 focus:border-ink";
